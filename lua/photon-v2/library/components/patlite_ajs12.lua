...
COMPONENT.Elements = {
	...
	[2] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/light_emis", DrawMaterial = "sentry/props/patlite_ajs12/glow_gradient_a", BloomMaterial = "sentry/props/patlite_ajs12/glow", BoneParent = 3, DLight = true, },
	[3] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/bulb_emis", BoneParent = 3 },
	...
	[7] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/light_emis", DrawMaterial = "sentry/props/patlite_ajs12/glow_gradient_a", BloomMaterial = "sentry/props/patlite_ajs12/glow", BoneParent = 4, DLight = true, },
	[8] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/bulb_emis", BoneParent = 4 },
	...
	[12] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/light_emis", DrawMaterial = "sentry/props/patlite_ajs12/glow_gradient_a", BloomMaterial = "sentry/props/patlite_ajs12/glow", BoneParent = 5, DLight = true, },
	[13] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/bulb_emis", BoneParent = 5 },
	...
	[17] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/light_emis", DrawMaterial = "sentry/props/patlite_ajs12/glow_gradient_a", BloomMaterial = "sentry/props/patlite_ajs12/glow", BoneParent = 6, DLight = true, },
	[18] = { "Mesh", Vector( 0.0, 0.0, 0.0 ), Angle( 0, 0, -90 ), "sentry/props/patlite_ajs12/bulb_emis", BoneParent = 6 },
