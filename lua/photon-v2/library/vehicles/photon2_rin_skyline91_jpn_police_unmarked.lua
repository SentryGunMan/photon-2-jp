...
VEHICLE.Title 		= "1991 Nissan Skyline GTR R32 Japanese Police Unmarked [Rin]"
VEHICLE.Vehicle		= "r32gtr2xeno"
...
VEHICLE.Equipment = {
    {
		...
		Options = {
			...
			{
				Option = "KG1 Jet Silver Metallic",
				Properties = {
					Skin = 1,
					Color = Color(134, 134, 146)
				}
			},
			{
			...
			{
				Option = "301 Light Red",
				Properties = {
					Skin = 0,
					Color = Color(221, 32, 32)
				}
			},
			{
				Option = "326 White",
