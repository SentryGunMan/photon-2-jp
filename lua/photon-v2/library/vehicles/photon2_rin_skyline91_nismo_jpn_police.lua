...
VEHICLE.Title 		= "1991 Nissan Skyline GTR Nismo R32 Japanese Police [Rin]"
...
SGM.AttachModelsByClass["photon2:photon2_rin_skyline91_jpn_police"] = {
	...
	{
        Model = "models/xenoscars/nissan/Nissan_Skyline_GTR_R32_NISMO.mdl",
        Pos = Vector(0,0,0),
        Ang = Angle(0,0,0),
        Color = Color(255,255,255),
        Scale = 1,
	...
	{
        Model = "models/xenoscars/nissan/Nissan_Skyline_GTR_R32_Interior_NISMO.mdl",
        Pos = Vector(0,0,0),
        Ang = Angle(0,0,0),
        Color = Color(255,255,255),
        Scale = 1,
